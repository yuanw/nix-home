...
** Prerequisites for 1Password CLI Git Credential Helper
The Linux hosts use 1Password CLI as the git credential helper. To set it up:

1. Ensure 1Password desktop app is installed and running
2. Enable CLI integration in 1Password:
   - Open 1Password > Settings > Developer
   - Enable "Integrate with 1Password CLI"
3. Set up GitHub plugin:
   - Run ~op plugin init gh~ to initialize the GitHub plugin
   - Or manually add GitHub credentials to 1Password
4. First git operation will prompt for authorization in the 1Password app
