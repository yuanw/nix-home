...
* Items of TODO
** TODO using ~niv~
https://github.com/mjlbach/nix-dotfiles/tree/master/nixpkgs
https://github.com/nmattia/niv#how-do-i-import-a-subpath-of-a-source
~niv add Stretchly -v 1.2.0 -t 'https://github.com/hovancik/stretchly/releases/download/v<version>/Stretchly-<version>.dmg'~
