      ...
      programs = {
        ...
        tmux = {
          ...
          extraConfig = ''
            ...
            set -g status-right "#{?client_prefix,#[reverse]<Prefix>#[noreverse] ,}#[fg=colour60,bg=colour60,nobold,nounderscore,noitalics]#[fg=colour146,bg=colour60] %Y-%m-%d  %H:%M #[fg=colour117,bg=colour60,nobold,nounderscore,noitalics]#[fg=colour232,bg=colour117] #h "
