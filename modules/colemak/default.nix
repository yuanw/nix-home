...
let
  ...
  colemak = pkgs.writeShellScriptBin "colemak" ''
    case "$1" in
      "l1" | "level1" | "1" ) gotta-go-fast -prw 60 $XDG_CONFIG_HOME/colemak/level1.txt;;
      "l2" | "level2" | "2" ) gotta-go-fast -prw 60 $XDG_CONFIG_HOME/colemak/level2.txt;;
      "l3" | "level3" | "3" ) gotta-go-fast -prw 60 $XDG_CONFIG_HOME/colemak/level3.txt;;
      "l4" | "level4" | "4" ) gotta-go-fast -prw 60 $XDG_CONFIG_HOME/colemak/level4.txt;;
      "l5" | "level5" | "5" ) gotta-go-fast -prw 60 $XDG_CONFIG_HOME/colemak/level5.txt;;
      *) gotta-go-fast -w 60;;
    esac
  '';
in {
