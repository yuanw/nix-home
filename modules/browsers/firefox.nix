    ...
    (mkIf cfg.enable {
      home-manager.users.${config.my.username} =
        ...
        let
          ...
          # Build all keybindings into commands structure
          allCommands = foldl' (
            acc: extId: acc // (buildKeybindings extId cfg.keybindings.settings.${extId})
          ) { } (attrNames cfg.keybindings.settings);
        in
        {
          ...
          mergetools = lib.mkIf (cfg.keybindings.enable && cfg.keybindings.settings != { }) {
            "firefox-extension-keybindings" = {
