{
  config = {
    ...
    search = {
      ...
      searchIconColor = "#89dceb";
      bookmarkIconColor = "#74c7ec";
      selectIconColor = "#f9e2af";
      engine = "kagi";
    ...
    bookmarks = {
      ...
      userDefined = [
        ...
        }
        {
          type = "bookmark";
          name = "okta";
          url = "https://workiva-gov.okta.com/app/UserHome";
          color = "#84cc16";
          iconType = "ri-login-box-line";
          iconColor = "#ffffff";
          fill = "";
        }
        {
          type = "bookmark";
          name = "jiar";
          url = "https://jira.atl.workiva.net/secure/Dashboard.jspa";
          color = "#84cc16";
          iconType = "nf-dev-jira";
          iconColor = "#ffffff";
          fill = "";
        }
        {
